...
{
  public class Case02_Test09_ExecutePayrolls
  {
    ...
    public void CrearEmpresaPI_DeberiaRegistrarConExito()
    {
      ...
      inputMonth.SendKeys("Junio\t2025");

      _driver.FindElement(By.CssSelector("form button")).Click();

      _wait.Until(d => d.FindElement(By.CssSelector("table tbody tr:nth-child(1) td:nth-child(3)")).Text.Contains("06-2025"));
    }
