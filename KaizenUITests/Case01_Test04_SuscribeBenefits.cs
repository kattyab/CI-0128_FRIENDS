...
{
  public class Case01_Test04_SuscribeBenefits
  {
    ...
    public void SuscribirBeneficiosPorEmpleado()
    {
      SuscribirBeneficioEmpleado(
          "pedro@empresapi.cr", "Password1*",
          new (string beneficio, string dependientes)[] { ("Gimnasio", null) }
      );

      SuscribirBeneficioEmpleado(
          "ana@empresapi.cr", "Password1*",
          new (string beneficio, string dependientes)[] { ("Educación", null) }
      );
