...
{
  public class Case01_Test05_ExecutePayrolls
  {
    ...
    public void CrearEmpresaPI_DeberiaRegistrarConExito()
    {
      ...
      inputMonth.SendKeys("Abril\t2025");

      _driver.FindElement(By.CssSelector("form button")).Click();

      _wait.Until(d => d.FindElement(By.CssSelector("table tbody tr:nth-child(1) td:nth-child(3)")).Text.Contains("04-2025"));
    }
