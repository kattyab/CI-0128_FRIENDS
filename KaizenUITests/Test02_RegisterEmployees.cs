...
{
  public class Test02_RegisterEmployees
  {
    ...
    public void CrearEmpleadosEmpresaPI_DeberiaRegistrarEmpleadosCorrectamente()
    {
      ...
      string[][] empleados = new string[][]
      {
        ...
        new string[] { "Pedro", "Vargas", "16-01-2000", "01-1234-0001", "CR11112222333344445555", "pedro@pi.cr", "Password1*", "Empleado", "Desarrollador", "Tiempo Completo", "Mensual", "500000", "01-04-2025" },
        new string[] { "Ana", "Salas", "23-12-1992", "01-1234-0002", "CR11112222333344445555", "ana@pi.cr", "Password1*", "Empleado", "Diseñadora", "Tiempo Completo", "Mensual", "1000000", "01-04-2025" },
        new string[] { "Juan", "Solano", "17-11-1985", "01-1234-0003", "CR11112222333344445555", "juan@pi.cr", "Password1*", "Empleado", "Líder Técnico", "Tiempo Completo", "Mensual", "4000000", "01-04-2025" }
