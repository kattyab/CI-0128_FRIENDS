  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: '/reports/companieshistoric', name: 'Companies Historic Payroll', component: () => import('./pages/reports/CompaniesHistoric.vue'), meta: { requiresAuth: true, requiredRoles: ['Superadmin'] } },
      ]
    },
    {
      path: '/auth',
