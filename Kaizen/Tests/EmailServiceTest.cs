...
namespace Tests
{
    ...
    public class EmailServiceTest
    {
        ...
        public void Setup()
        {
            ...
            _configuration.GetSection(nameof(EmailConfiguration)).Bind(emailConfiguration.Value);

            _emailService = new EmailService(_logger.Object, emailConfiguration);
        }
        ...
        public async Task SendEmail_Success()
        {
            ...
            await _emailService.SendEmail(testEmail);
